const CACHE='needledrop-v8-0';
const CORE=['/','/needledrop-icon.png','/needledrop-icon.svg','/record-room/audiophile-room.svg','/record-room/teen-bedroom.svg','/record-room/record-store.svg'];
